...
@onready var lbl_desc = $TextureRect/lbl_desc
@onready var icons = [
...
var item_preco = ["2X carvão   1X ação", "2X madeira 1X ação", "2X madeira 1X ação"]
var current_item = 3
...
var full_text_cerca2 = [
		"Um conjunto adicional de cercas."]
var full_text_start = [
		"Seja muito bem vindo(a)! Sinta-se em casa e fique a vontade para olhar em volta."]
...
func _on_btn_comprar_pressed() -> void:
	var funcs = [buy_toalha(), buy_cerca1(), buy_cerca2()]
	if current_item == 3:
		return
